...
execute_process(
  COMMAND "/usr/bin/git" show-ref "741fb3ab6c7e1f7cef23ad0501a06b7c2b354944"
  WORKING_DIRECTORY "/home/chli/github/ASDF/sibr-core/extlibs/imgui/imgui"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "741fb3ab6c7e1f7cef23ad0501a06b7c2b354944")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("741fb3ab6c7e1f7cef23ad0501a06b7c2b354944" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/741fb3ab6c7e1f7cef23ad0501a06b7c2b354944")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/chli/github/ASDF/sibr-core/extlibs/imgui/imgui'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/chli/github/ASDF/sibr-core/extlibs/imgui/imgui'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
